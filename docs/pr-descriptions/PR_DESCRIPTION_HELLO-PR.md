...
![grid-operators-new-columns-desktop](DRAG_DROP:grid-operators-new-columns-desktop.png)
...
![dropdown-chevron-padding-desktop](DRAG_DROP:dropdown-chevron-padding-desktop.png)
![dropdown-chevron-padding-mobile](DRAG_DROP:dropdown-chevron-padding-mobile.png)
_Inner right-side padding on native `<select>` elements across all data pages._

### Header Spacing (desktop)
![header-spacing-desktop](DRAG_DROP:header-spacing-desktop.png)
_h-14 → h-12, tighter nav link padding, adjusted logo-to-nav gap._

### Badge Variants (desktop)
![badge-variants-desktop](DRAG_DROP:badge-variants-desktop.png)
_Corrected badge color mapping for all utility segment types._

### Sort Chevrons (desktop)
![sort-chevrons-desktop](DRAG_DROP:sort-chevrons-desktop.png)
_Sort direction ▲/▼ indicators in dropdown labels on power-plants._

### Changelog Redesign (tablet + desktop)
![changelog-tabs-desktop](DRAG_DROP:changelog-tabs-desktop.png)
![changelog-tabs-tablet](DRAG_DROP:changelog-tabs-tablet.png)
...
![filter-stacking-mobile](DRAG_DROP:filter-stacking-mobile.png)
_Filter dropdowns stack full-width vertically on narrow viewports._

### Name Clamping (mobile)
![name-clamping-mobile](DRAG_DROP:name-clamping-mobile.png)
_2-line name clamp on grid-operators cards at 375px._

### Mobile Menu (mobile)
![mobile-menu-mobile](DRAG_DROP:mobile-menu-mobile.png)
