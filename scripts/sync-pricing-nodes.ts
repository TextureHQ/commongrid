...
const TRADING_HUBS: RawPricingNode[] = [
  ...
  {
    id: "nyiso-zone-e",
    name: "NYISO Zone E (Mohawk Valley)",
    iso: "NYISO",
    nodeType: "zone",
    latitude: 43.1,
    longitude: -75.23,
  ...
  {
    id: "nyiso-zone-g",
    name: "NYISO Zone G (Hudson Valley)",
    iso: "NYISO",
    nodeType: "zone",
    latitude: 41.5,
    longitude: -74.01,
  ...
  {
    id: "isone-sema",
    name: "SE Massachusetts Load Zone",
    iso: "ISONE",
    nodeType: "zone",
    latitude: 41.64,
    longitude: -70.93,
  ...
  {
    id: "isone-wcma",
    name: "W/C Massachusetts Load Zone",
    iso: "ISONE",
    nodeType: "zone",
    latitude: 42.27,
    longitude: -71.8,
  ...
  {
    id: "isone-nema",
    name: "NE Massachusetts / Boston Load Zone",
    iso: "ISONE",
    nodeType: "zone",
    latitude: 42.36,
    longitude: -71.06,
...
const ERCOT_ZONES: RawPricingNode[] = [
  ...
  {
    id: "ercot-lz-cps",
    name: "ERCOT CPS Energy Load Zone",
    iso: "ERCOT",
    nodeType: "zone",
    latitude: 29.42,
    longitude: -98.49,
...
const MISO_ZONES: RawPricingNode[] = [
  ...
  {
    id: "miso-zone-9",
    name: "MISO Zone 9 (Louisiana/Texas)",
    iso: "MISO",
    nodeType: "zone",
    latitude: 30.46,
    longitude: -91.19,
...
const SPP_ZONES: RawPricingNode[] = [
  ...
  {
    id: "spp-wfec",
    name: "Western Farmers Electric Coop",
    iso: "SPP",
    nodeType: "zone",
    latitude: 34.98,
    longitude: -97.52,
