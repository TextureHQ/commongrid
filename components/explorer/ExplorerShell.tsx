...
function HybridLayout({ mapboxAccessToken }: HybridLayoutProps) {
  ...
  return (
    <div ref={containerRef} className="flex h-full overflow-hidden">
      ...
      {/* Resize handle */}
      {/* biome-ignore lint/a11y/noStaticElementInteractions: drag-resize handle, no keyboard alternative needed */}
      <div
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 min-h-0 relative">
        ...
        <div className="hidden md:block h-full">
          {layout === "hybrid" && <HybridLayout mapboxAccessToken={mapboxAccessToken} />}
          {layout === "list" && (
