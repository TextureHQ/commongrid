  ...
  const layers = useMemo(() => {
    ...
    result.push(
      layer.vector({
        ...
        ...(transmissionLinesFilter ? { filter: transmissionLinesFilter as any } : {}),
        renderAs: "line",
        minZoom: 3,
    ...
    result.push(
      layer.vector({
        ...
        ...(substationsFilter ? { filter: substationsFilter as any } : {}),
        renderAs: "circle",
        minZoom: 5,
    ...
    result.push(
      layer.vector({
        ...
        ...(evChargingFilter ? { filter: evChargingFilter as any } : {}),
        renderAs: "circle",
        minZoom: 5,
    ...
    result.push(
      layer.vector({
        ...
        ...(pricingNodesFilter ? { filter: pricingNodesFilter as any } : {}),
        renderAs: "circle",
        minZoom: 3,
    ...
    result.push(
      layer.vector({
        ...
        ...(powerPlantsFilter ? { filter: powerPlantsFilter as any } : {}),
        renderAs: "circle",
        minZoom: 5,
