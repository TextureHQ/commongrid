...
export type EntityTab = "utilities" | "grid-operators" | "power-plants" | "programs" | "transmission-lines" | "ev-charging" | "pricing-nodes";
...
function parseTab(value: string | null): EntityTab {
  const valid: EntityTab[] = ["utilities", "grid-operators", "power-plants", "programs", "transmission-lines", "ev-charging", "pricing-nodes"];
