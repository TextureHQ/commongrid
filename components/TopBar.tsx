      ...
      <div className="flex items-center justify-between h-16 px-5">
        ...
        <nav className="hidden sm:flex items-center gap-1">
            ...
            <Link
              ...
              className={`px-3.5 py-2 rounded-md text-[15px] transition-colors ${
                isActive(item)
                  ...
                  : "text-text-muted hover:text-text-body hover:bg-background-subtle"
              }`}
            >
              {item.label}
            </Link>
          ...
          <a
            ...
            className="ml-2 p-1.5 rounded-md text-text-muted hover:text-text-body hover:bg-background-subtle transition-colors"
          ...
          {mounted && (
            <button
              type="button"
              onClick={toggleTheme}
              className="ml-1 p-1.5 rounded-md text-text-muted hover:text-text-body hover:bg-background-subtle transition-colors"
        ...
        <div className="flex items-center gap-2 sm:hidden">
          {mounted && (
            <button
              type="button"
              onClick={toggleTheme}
              className="p-1.5 rounded-md text-text-muted hover:text-text-body hover:bg-background-subtle transition-colors"
              aria-label="Toggle color mode"
            >
              <Icon name={isDarkTheme ? "Sun" : "Moon"} size={18} />
            </button>
      ...
      {mobileMenuOpen && (
        <nav className="sm:hidden border-t border-border-default px-4 py-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-text-muted hover:text-text-body hover:bg-background-subtle transition-colors"
          >
