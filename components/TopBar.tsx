            ...
            {navigation.map((item) =>
              item.external ? (
                <a
                  ...
                  className="px-3 py-1.5 rounded-md text-sm transition-colors text-text-muted hover:text-text-body hover:bg-[var(--color-background-default)]"
                >
                  {item.label}
                </a>
              ) : (
                <Link
                  ...
                  className={`px-3 py-1.5 rounded-md text-sm transition-colors ${
                    isActive(item)
                      ? "text-text-body font-medium bg-[var(--color-background-default)]"
                      : "text-text-muted hover:text-text-body hover:bg-[var(--color-background-default)]"
                  }`}
                >
                  {item.label}
                </Link>
          ...
          {navigation.map((item) =>
            item.external ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block px-3 py-2 rounded-md text-sm transition-colors text-text-muted hover:text-text-body hover:bg-[var(--color-background-default)]"
              >
                {item.label}
              </a>
            ) : (
