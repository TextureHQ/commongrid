      ...
      <header className="cg-nav">
        <div className="cg-nav-inner">
          ...
          <div className="cg-nav-right">
            ...
            {/* GitHub — labeled pill so the open-source repo is an
               obvious destination rather than an easy-to-miss icon. */}
            <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" className="cg-nav-github">
              <GitHubIcon />
              <span>GitHub</span>
            </a>
