...
const GitHubIcon = () => (
  <svg aria-hidden="true" viewBox="0 0 16 16" fill="currentColor" className="h-[18px] w-[18px]">
      ...
      <div className="flex items-center h-14 px-5">
        ...
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-[15px] font-semibold text-text-heading tracking-tight">CommonGrid</span>
          </Link>
        ...
        <div className="ml-auto flex items-center gap-1 sm:hidden">
          ...
          <Button variant="icon" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Toggle menu">
