/**
 * The changelog feed, as data.
 *
 * Shared by the API route and the changelog page. The page renders this on the
 * server: fetching it in the browser meant painting the static fallback first
 * and swapping it for the real feed a moment later, which read as the page
 * changing its mind.
 */
...
export async function fetchChangelogFeed(params: ChangelogQuery): Promise<ChangelogFeed> {
