...
const ENTITY_CARDS = [
  ...
  },
  {
    ...
    href: "/explore/transmission-lines",
          ...
          <div className="grid md:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] gap-[clamp(32px,5vw,64px)] md:items-start">
            <div className="min-w-0 md:pt-8">
              ...
              <p className="text-[length:var(--text-body-xl-size)] font-[var(--text-body-xl-weight)] leading-[var(--text-body-xl-line-height)] tracking-[var(--text-body-xl-letter-spacing)] text-text-muted max-w-[60ch] m-0 [text-wrap:pretty]">
                ...
                energy infrastructure data into a public, shareable model. Anyone can contribute what&rsquo;s missing
                and sharpen what&rsquo;s rough, and the data is free to use under an open license.
              </p>
            </div>
        ...
        <div className="max-w-[1280px] mx-auto px-[clamp(20px,4vw,56px)]">
          <div className="grid lg:grid-cols-[2fr_1fr_1fr_1fr] md:grid-cols-3 sm:grid-cols-2 gap-8 md:gap-y-8 md:gap-x-6 sm:gap-y-7 sm:gap-x-4">
            ...
            <div>
              ...
              {[
                { href: "/explore/utilities", label: "Utilities" },
                { href: "/explore", label: "Territories" },
                { href: "/explore/grid-operators", label: "Operators" },
                { href: "/explore/power-plants", label: "Power plants" },
                { href: "/explore/substations", label: "Substations" },
                { href: "/explore/ev-charging", label: "EV charging" },
