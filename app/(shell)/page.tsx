...
const ENTITY_CARDS = [
  {
    id: "utilities",
    href: "/explore?view=utilities&mode=table",
  ...
  {
    id: "grid-operators",
    href: "/explore?view=grid-operators&mode=table",
  ...
  {
    id: "programs",
    href: "/explore?view=programs&mode=table",
  ...
  {
    id: "rates",
    href: "/explore?view=rates&mode=table",
    name: "Rates & tariffs",
    desc: "Every commercial and residential rate — searchable by utility, rate type, and program.",
    tags: ["TOU", "Structured"],
  },

  {
    id: "power-plants",
    href: "/explore?view=power-plants&mode=map",
    name: "Power plants",
  ...
  },
  {
    ...
    href: "/explore?view=transmission-lines&mode=map",
  ...
  {
    id: "ev-charging",
    href: "/explore?view=ev-charging&mode=map",
  ...
  {
    id: "pricing-nodes",
    href: "/explore?view=pricing-nodes&mode=map",
    name: "Pricing nodes",
  ...
  {
    id: "substations",
    href: "/explore?view=substations&mode=map",
    name: "Substations",
